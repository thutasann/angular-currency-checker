...
export class CoinDetailComponent implements OnInit {
  ...
  @ViewChild(BaseChartDirective) myLineCharat !: BaseChartDirective;
  ...
  getGraphData(days:number){
    ...
    this.api.getGrpahicalCurrencyData(this.coinId, this.currency, 30).subscribe(res => {

      setTimeout(() => {
        this.myLineCharat.chart?.update();
      }, 200);
